...
import requests
import sqlalchemy
from flask import render_template, request, redirect, url_for, Blueprint, Flask, jsonify, sessions
...
def pay():
    ...
    if points == 0:
        ...
        for user in all_user:
            ...
            session.commit()
            name = user.user_name
            # url = 'http://192.168.100.63:100.63/point'
...
if __name__ == "__main__":
    app1.run(debug=False, host='0.0.0.0', port=5002)